<template>
  <div>
    <b-navbar toggleable="false" type="dark" variant="dark">
      ...
      <b-collapse id="navbar-toggle-collapse" is-nav>
        <b-navbar-nav class="ml-auto">
          ...
          >
          <b-nav-item
            ><router-link style="text-decoration: none; color: white" to="/form"
              >Submit new Patient</router-link
            ></b-nav-item
          >
    ...
    <b-button @click="getDiagnoses" variant="outline-primary"
      >Get Diagnoses predicted by Symptoms</b-button
    >
